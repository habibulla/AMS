...
public class InvoiceDAO {
    ...
    public void fillVehicle(InvoiceForm form) {
        String sql = "";
        ResultSet rs = null;
        Connection con = null;
        Statement stmt = null;
    ...
    public void fillOtherCharge(InvoiceForm form) {
        String sql = "";
        ResultSet rs = null;
        Connection con = null;
        Statement stmt = null;
        ...
        try {
            ...
            sql = "select * from othercharges order by description";

            rs = stmt.executeQuery(sql);

            while (rs.next()) {

                dropDowList.add(new DropDownFill(rs.getInt("otherchargesid"), rs.getString("description")));

            }

            form.setOtherCharges(dropDowList);
            form.setSelectedOtherCharge(form.getSelectedOtherCharge());

        } catch (Exception e) {
            log.info("SQL exception fetching otherCharge ery:" + sql + "\n" + e.getMessage());
            e.printStackTrace();
        } finally {
    ...
    public void fillInvoiceNo(InvoiceForm form) {
        String sql = "";
        ResultSet rs = null;
        Connection con = null;
        Statement stmt = null;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                form.setInvoiceNo(rs.getInt("invoiceno"));
