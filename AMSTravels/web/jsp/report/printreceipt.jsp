        ...
        <html:form action="receipt">
            ...
            <table align="center" border="0" style="position:relative;width:80%"><tr><td>
                ...
                <tr><td colspan="3"> <center>  <b>AMS TOURS AND TRAVELS</b> </br> 5-3-130/1,OPP,CENTRAL WARE HOUSE,MANNAGUDDA MAIN ROAD,MANGALORE - 575003<br/>
                        ...
                        Receipt No : <bean:write name="reportForm" property="receiptNoR" /></td>
                    <td><center>Receipt Date : <bean:write name="reportForm" property="receiptDateR" /> </center></td></tr></table>
            <table align="center" border="0" style="position:relative;width:70%"><center><tr><td>
                            <center>Received with thanks from Sri / Smt <bean:write name="reportForm" property="customerNameR" />
                                 <bean:write name="reportForm" property="amountInWordsR" />
                                  ,as the hire charges by car / bus  bearing Reg No. <bean:write name="reportForm" property="vehicleR" />  ,in
                                <bean:write name="reportForm" property="paymentTypeR" /> payment by <bean:write name="reportForm" property="paymentModeR" /> </center><br/><br/></td></tr></center><tr><td align="right">
                        For AMS Tours and Travels</td></tr><tr><td><b>Rs.<u> <bean:write name="reportForm" property="amountR" /></u></b></td></tr></table>
<br/>
