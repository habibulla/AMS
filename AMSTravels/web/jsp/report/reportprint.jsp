            ...
            <div align="center" id="report">
                ...
                <table align="center" border="1" cellspacing="0" style="position:relative;  width:75%;">
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            <bean:write name="reportForm" property="customerNameR"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            <bean:write name="reportForm" property="addressR"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        ...
                        <td colspan="6">
                            <bean:write name="reportForm" property="mobileNoR"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="6">
                            <bean:write name="reportForm" property="descriptionR"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        ...
                        <td colspan="1">
                            <bean:write name="reportForm" property="invoiceNoR"/>
                        </td>
                        <td colspan="2">
                            Invoice Date
                        </td>
                        <td colspan="3">
                            <bean:write name="reportForm" property="invoiceDateR"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <logic:notEmpty name="reportForm" property="invoiceListR">
                        <logic:iterate id="details" name="reportForm" property="invoiceListR">
                            <tr>
                    ...
                    <logic:notEmpty name="reportForm" property="chargeDetailsListR">
                        <logic:iterate id="details" name="reportForm" property="chargeDetailsListR">
                            <tr>
                    ...
                    <tr><td colspan="1">
                        ...
                        <td colspan="1">
                            <bean:write name="reportForm" property="grandTotalR" />
                        </td>
                        <td colspan="1">
                            Amount In words
                        </td>
