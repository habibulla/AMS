...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div class="container">
                <html:form action="OutofStation"  >

                    <div class="navbar-collapse collapse" >
                        <ul class="nav navbar-nav">
                            <li>
                                <a href="local.do?method=displayReceipt">
                                    <img src="" alt="Local Trip" />
                                    Local Trip</a>
                            </li>
                            <li>
                                <a href="Airport.do?method=displayInvoice">Airport Trip</a>
                            </li>
                            <li>
                                <a href="OutofStation.do?method=displaySettings">Out Of Station</a>
                            </li>
                    ...
                    <div class="layer1" style="position:relative ;left:0%;width: 59%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <html:select  property="selectedFromlocation"  style="width:100%">
                                        ...
                                        <html:optionsCollection property="fromlocation"  value="id" label="label" />
                                    </html:select>
                                </td>
                                <td>To Location: </td>
                                <td>
                                    <html:select  property="selectedtolocation"  style="width:100%">
                                        <html:option value="" >--Select--</html:option>
                                        <html:optionsCollection property="tolocation"  value="id" label="label" />
                                    </html:select>
                                </td>
                            </tr>
                        </table>
                        <table class="table-condensed" style="font-size:12px;border: 1px;padding: 10px">
                            ...
                            <tr>
                                <td>
                                    <html:select  property="checkedVehicle"  style="width:100%" onchange="">
                                        <html:option value="" >--Select--</html:option>
                                ...
                                <td></td> <td>
                                    <html:image property="path" src="path" value="path" title="enter mobile no" style="height:60px;width:60px;"/>
                                </td>
                            </tr>
                            <tr>
